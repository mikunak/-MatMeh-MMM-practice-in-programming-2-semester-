...
class Messages:
    ...
    SHOW_KEYS = 'API Ключ: `{}`\nSecret Ключ: `{}`'
    BAD_KEYS_FORMAT = 'Неправильный формат ввода ключей! Попробуйте еще раз или перезапустите бота'
    ERROR_GETTING_KEYS = 'Ключи не введены'
    ...
    DREAMING_VALUE = 'Отлчино! Введите количество коинов большее нуля, которое вы бы купили!'
    ...
    DREAM_ERROR = 'Произошла ошибка! Вероятно, Вы ввели слишком раннюю дату или данные за эту дату не доступны!'
